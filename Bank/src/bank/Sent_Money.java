...
public class Sent_Money extends JFrame {
    Container c; 
                    ...
                    else
                    {
                             ...
                             {  
                                  ...
                                  try
                                  {
                                        ...
                                        if(st>=vul)
                                        {
                                             FileWriter fw1=new FileWriter("C:/Users/USER/Desktop/Sent_Money.txt");
                                             ...
                                             dispose();
                                             Sent_Success ls=new Sent_Success();
    ...
    public static void main(String[] args) {
        Sent_Money frame8 = new Sent_Money();

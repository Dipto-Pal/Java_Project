...
public class Mobile_Recharge extends JFrame {
    Container c; 
    ...
    class Handler implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            { 
                    ...
                    {
                       Mobile_Recharge_Fail sf=new Mobile_Recharge_Fail();
                       dispose();
                    }
                    else
                    {
                             ...
                             {  
                                  ...
                                  try
                                  {
                                        ...
                                        if(st>=vul)
                                        {
                                             FileWriter fw1=new FileWriter("C:/Users/USER/Desktop/Mobile_Recharge.txt");
                                             ...
                                             dispose();
                                             Mobile_Recharge_Success ls=new Mobile_Recharge_Success();
    ...
    public static void main(String[] args) {
        Mobile_Recharge frame17 = new Mobile_Recharge();

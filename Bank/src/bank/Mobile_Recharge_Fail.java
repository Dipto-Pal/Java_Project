...
public class Mobile_Recharge_Fail extends JFrame {
    Container c; 
    
    JLabel jlll12;
    JButton jbbb12;
    static String ban;
    public Mobile_Recharge_Fail()
    { 
        setVisible(true);
    ...
    class Handler implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e)
        {
           ...
           {
               Mobile_Recharge acc=new Mobile_Recharge();
               dispose();
           }
    ...
    public static void main(String[] args) {
        Mobile_Recharge_Fail frame18 = new Mobile_Recharge_Fail();

...
public class Mobile_Recharge_Success extends JFrame {
     Container c; 
    ...
    JButton jbbb12;
    static String ban;
    public Mobile_Recharge_Success()
    { 
        setVisible(true);
        ...
        c.setLayout(null);
        jlll12=new JLabel("Recharge Successfully  !!!");
        jlll12.setBounds(80, 100, 270, 30);
        jlll12.setFont(new Font("Arial Black", Font.PLAIN, 15));
        c.add(jlll12);
        ...
        jbbb12.setBounds(200,150,60,20);
        c.add(jbbb12);
        ...
        try
          {
             FileReader fr12=new FileReader("C:/Users/USER/Desktop/Mobile_Recharge.txt");
    ...
    public static void main(String[] args) {
        Mobile_Recharge_Success frame19 = new Mobile_Recharge_Success();
        frame19.setResizable(false);

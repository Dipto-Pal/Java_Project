...
public class Balance_Show extends JFrame{
    Container c; 
    ...
    { 
        ...
        c.setLayout(null);
        jlll12=new JLabel("Add Successfully  !!!");
        ...
        try
          {
             FileReader fr12=new FileReader("C:/Users/USER/Desktop/Balance_Demo.txt");
    ...
    public static void main(String[] args) {
        Balance_Show frame8 = new Balance_Show();
